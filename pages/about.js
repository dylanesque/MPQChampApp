    ...
    <>
      ...
      <main className="page-main">
        ...
        <p>
          ...
          That's why I created MPQ Hall Of Champions to automate this task!
        </p>
        <h3 className="page-heading">How It Works</h3>
        <p>
          Users of the time-honored{' '}
          <a href="https://mpq.gamependium.com/">MPQ Gamependium</a> utility
          will notice a similar feel to this application. When you create an
          account, the application will create a seed database for you that
